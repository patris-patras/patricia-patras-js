...
console.warn(
  'Prietenul meu Steven Stevenson are xx ani.” folosind doar proprietatile',
);
console.log(
  'Prietenul meu ' +
    person.friends.steven.name +
...
asa nu:
console.log(
  person.friends.steven.name.length.toString() - person.friends.carol.name.length.toString()
);
